...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nA duração do filme "+filme06.getTituloFilme()+" em horas é: "+filme06.exibirDuracaoEmHoras());
		...
		System.out.println("\nA duração do filme "+filme07.getTituloFilme()+" em horas é: "+filme07.exibirDuracaoEmHoras());
	}
}
